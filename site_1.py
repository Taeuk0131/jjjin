...
st.title("서진이를 소개하는 페이징")

# 사이드바에 버튼 배열
st.sidebar.header("버튼을 클릭해보세요")

large_buttons = {
    "나의 아바타": "c:\Users\User\Downloads\문서진.mp3",  # 이 경로를 실제 아바타 비디오 파일로 변경하세요.
    "나를 표현한 음악": "c:\Users\User\Downloads\신나게.mp3"  # 이 경로를 실제 음악 파일로 변경하세요.
}

small_buttons = {
    "서진이의 장점": "착하고, 문제 해결을 좋아합니다.",
    "서진이의 희망 진로": "소프트웨어 엔지니어가 되고 싶습니다.",
    "서진이가 좋아하는 것": "여행, 소설을 좋아합니다.",
    "서진이가 싫어하는 것": "게으름, 미루는 습관을 싫어합니다.",
    "서진이의 자기 소개": "안녕하세여. 전 서진입니다.",
    "서진이의 진로 준비": "여기에 진로를 위해 어떤 준비를 하고 있는지 구체적으로 설명해주세요.",
    "서진이의 취미 활동": "취미 활동에 대해 이야기하세요. 예를 들어, 스포츠, 음악, 예술 등에 대해 이야기할 수 있습니다.",
    "서진이의 성공 사례": "성공 사례를 공유하세요. 예를 들어, 프로젝트, 대회 수상, 특별한 경험 등에 대해 이야기할 수 있습니다."
}
